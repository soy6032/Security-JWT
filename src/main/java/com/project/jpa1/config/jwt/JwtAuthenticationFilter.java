package com.project.jpa1.config.jwt;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.project.jpa1.config.auth.LoginUser;
import com.project.jpa1.dto.UserReqDto;
import com.project.jpa1.dto.UserReqDto.LoginReqDto;
import com.project.jpa1.dto.UserRespDto.LoginRespDto;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            LoginReqDto loginReqDto = om.readValue(request.getInputStream(), UserReqDto.LoginReqDto.class);
            ...
            System.out.println(((LoginUser)(authentication.getPrincipal())).getUsername());
